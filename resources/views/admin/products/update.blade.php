            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin/products/update', $products->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <label>Created At: {{ \Carbon\Carbon::parse($products->created_at)->format('d M Y H:i') }}</label>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                <label>Updated At: {{ \Carbon\Carbon::parse($products->updated_at)->format('d M Y H:i') }}</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="d-grid">
